...
* [7. Download source repo and customize](#step-7-download-source-repo-and-customize)
  ...
  - [7.5  Specify LDAP Credentials in MFP Adapter](#74-specify-ldap-credentials-in-mfp-adapter)
  - [7.6 Specify Google Sign-in credentials in MFP Adapter](#74-specify-google-sign-in-credentials-in-mfp-adapter)
  - [7.7 Specify the Facebook AppID and Google clientID in the Ionic App](#74-specify-the-facebook-appid-and-google-clientid-in-the-ionic-app)
